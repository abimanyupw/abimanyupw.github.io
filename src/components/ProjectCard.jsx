...
const ProjectCard = ({
  ...
  return (
    <>
      ...
      {/* 🔥 MODAL VIA PORTAL (ANTI BUG MOBILE) */}
      {showDetails &&
                  ...
                  <div className="flex flex-col gap-3">
                    {demoLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-2xl text-center flex items-center justify-center gap-2 shadow-xl shadow-indigo-600/20"
                      >
